...
Аппроксимация строится на выпуклом четырехугольнике (выпуклость дополнительно проверяется в программе) с вырезом на стороне в виде подобного ему четырехугольника. Более подробная информация о задании области содержится в файле **[Setting the area.pdf](Setting%20the%20area.pdf)**, там же содержится информация о запуске программы.
